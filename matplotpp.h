...
class MatPlot{///
 ...
 public:
  ...
  void xaxis(double xMin,double xMax);//not in Matlab
  void yaxis(double yMin,double yMax);//not in Matlab  
  ...
  int surface(dmat Z,dmat C);//(not in matlab)
